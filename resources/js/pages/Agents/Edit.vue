...
import type { Agent, Tool } from '@/types/models';
...
const form = ref({
    ...
    config: JSON.stringify(props.agent.config || {}, null, 2),
...
<template>
    <AuthenticatedLayout :title="`Edit ${agent.name}`" :auth="auth">
        <div class="space-y-6">
            <!-- Page Header -->
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold tracking-tight">Edit Agent</h1>
                    <p class="text-muted-foreground">Update "{{ agent.name }}"</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Update the agent's name and description</CardDescription>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Update the agent's behavior</CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-4">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Update tools the agent can use</CardDescription>
                    </CardHeader>
                    <CardContent>
